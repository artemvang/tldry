...
def test_russian_text(russian_tldr, russian_text):
    ...
    assert summary == [
        ...
        (
            'Но здесь это настолько прямолинейно иронично, что лишается '
            'собственно иронического прочтения.'
        ),
        (
        ...
        (
            ...
            'серьезности, так и от риска полной идентификации с '
            'крайними состояниями чувств.'
        ),
        (
